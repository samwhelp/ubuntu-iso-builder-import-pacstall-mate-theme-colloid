...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-mate-theme-colloid"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-mate-theme-colloid/iso-profile
"
echo
